...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleGoogleSignUp() async {
    ...
    // On success, the browser opens.
    // Supabase's auth-state listener updates the provider
    // when the OAuth callback returns to campusx://auth-callback.
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GlassTextField(
                      ...
                      // FIX:
                      // Registration screen must submit
                      // registration, not _handleLogin().
